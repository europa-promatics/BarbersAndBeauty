...
export class MyApp {
  ...
  constructor(
    ...
    private network: Network,private fcm: FCM
   ) {
    ...
    this.pages = [
	   ...
	   { title: 'NOTIFICATION SETTINGS', component:'EmployeeOnlineOffline', logo: 'assets/icon/icon19.png'},
    ...
    this.employeeside = [
      { title: 'HOME', component:'EmployeeHome' , logo: 'assets/icon/icon8.png'},
       ...
       { title: 'SETTINGS', component:'EmployeeOnlineOffline', logo: 'assets/icon/icon19.png'},
      ]
