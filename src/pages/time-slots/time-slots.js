 ...
 */
var TimeSlots = /** @class */ (function () {
    function TimeSlots(navCtrl, navParams, viewctrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewctrl = viewctrl;
    }
    TimeSlots.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad TimeSlots');
    };
    TimeSlots.prototype.cancel = function () {
        this.viewctrl.dismiss();
    };
    TimeSlots.prototype.accept = function () {
