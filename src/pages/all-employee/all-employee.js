 ...
 */
var AllEmployee = /** @class */ (function () {
    function AllEmployee(navCtrl, dataservice, navParams, alertCtrl, loadingCtrl, modalCtrl) {
    ...
    AllEmployee.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AllEmployee');
    };
    AllEmployee.prototype.view = function (data) {
        alert(JSON.stringify(data));
        this.navCtrl.push('SpecificEmployee', { profiledata: data });
    };
    AllEmployee.prototype.ngOnInit = function () {
        var _this = this;
        ...
        Observable.fromPromise(loading.present())
            ...
            return loading.dismiss().then(function () {
                ...
                alert(JSON.stringify(_this.minedata));
    ...
    AllEmployee.prototype.add_staff = function () {
        var _this = this;
...
export { AllEmployee };
//# sourceMappingURL=all-employee.js.map