 ...
 */
var EmployeeCustomerInfo = /** @class */ (function () {
    function EmployeeCustomerInfo(navCtrl, navParams) {
    ...
    EmployeeCustomerInfo.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad EmployeeCustomerInfo');
    };
    EmployeeCustomerInfo = __decorate([
        IonicPage(),
        Component({
    ...
    return EmployeeCustomerInfo;
}());
export { EmployeeCustomerInfo };
//# sourceMappingURL=employee-customer-info.js.map