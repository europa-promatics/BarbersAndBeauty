...
/**
 * Generated class for the SpecificEmployee2Page page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
var SpecificEmployee2Page = /** @class */ (function () {
    function SpecificEmployee2Page(navCtrl, dataservice, navParams, alertCtrl, loadingCtrl) {
    ...
    SpecificEmployee2Page.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad SpecificEmployee2Page');
    };
    SpecificEmployee2Page.prototype.showConfirm = function () {
        var _this = this;
    ...
    SpecificEmployee2Page.prototype.delete_staff = function () {
        var _this = this;
    ...
    SpecificEmployee2Page = __decorate([
        IonicPage(),
        Component({
            selector: 'page-specific-employee2',
            templateUrl: 'specific-employee2.html',
        }),
        __metadata("design:paramtypes", [NavController, DataService,
            NavParams, AlertController,
            LoadingController])
    ], SpecificEmployee2Page);
    return SpecificEmployee2Page;
}());
export { SpecificEmployee2Page };
//# sourceMappingURL=specific-employee2.js.map