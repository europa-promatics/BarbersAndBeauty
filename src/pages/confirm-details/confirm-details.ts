...
export class ConfirmDetails {
  ...
  constructor(
    ...
    public loadingCtrl:LoadingController) {
			...
			//  alert("date"+ this.ISODateString(this.selecteddate))
              this.date=new Date(this.ISODateString(this.selecteddate))
			 ...
			 // alert("split"+demo.split(" "))
               ...
               let demo2=demo.split(" ");
                ...
                console.log(demo)
                console.log(demo2)
             this.exactday=this.ISODateStrin(this.selecteddate)
...
ISODateString(d){
	...
	a=a[0]+', '+(a[1])+', '+a[2];
	//a=a[0].toString()+', '+(a[1]-1).toString()+', '+a[2].toString()+', '+a[3].toString()+', 00, 00';
