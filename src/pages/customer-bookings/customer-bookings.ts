...
ngOnInit(){
     ...
     let loading = this.loadingCtrl.create({content: 'Please Wait...'});
         ...
         .subscribe(data =>
                ...
                this.cancelinfo=this.bookingdata.cancelinfo.reverse(); 
                this.currentdata=this.bookingdata.currentinfo.reverse(); 
                this.salon_payment_status=this.currentdata.online_booking
...
pay(payment_id,cost,salonname,salonid,online_payment_status){
...
if(this.salon_payment_status==1){
  ...
  // Error in initialization, maybe PayPal isn't supported or something else
     ...
     if(this.salon_payment_status==0){
        let alert=this.alertCtrl.create({
                title:'Oops',
